...
const ShopDetails = ({ pageContext }) => {
  ...
  const rc =
    recommendation.filter((node) =>
      recommendList.some((r) => r === node.node.shopifyId)
    ) ?? []
  console.log(rc)
  ...
  const handleOptionChange = (index, value, event) => {
    ...
    if (index == 0) {
      ...
      if (clickedIndex != -1) imagesNavSlider.slideTo(clickedIndex)
    }
  ...
  //debugger
  var showSamples =
    showMaterialSamples?.value === "true" || showMaterialSamples === undefined
      ? true
      : false
  var showButton =
    showCustomizeButton?.value === "true" || showCustomizeButton === undefined
      ? true
      : false
  var showDet =
  ...
  var showBannr =
    showBanner?.value === "true" || showBanner === undefined ? true : false
  var showComp =
    showComplimentary?.value === "true" || showComplimentary === undefined
      ? true
      : false
        ...
        <div className="container">
          <div className="row row_padding">
            ...
            <div className="col-12 col-md-8 col-lg-5">
                      ...
                      product.options.map(({ id, name, values }, index) => (
                        <div className="d-flex align-items-start mb-3">
                          ...
                          <OverlayTrigger
                            ...
                            overlay={
                              <Tooltip id="button-tooltip-color">
                                Looking for more? Contact us to customise your
                                colour combination.
                              </Tooltip>
                            }
                          >
                            <div className="d-flex pointer align-self-center mb-3">
                              <img
                              ...
                              {values.map((value) => (
                                <li>
                                  <OverlayTrigger
                                    ...
                                    delay={{ show: 250, hide: 400 }}
                                    overlay={
                                      <Tooltip id="button-tooltip-divider">
                                        {value}
                                      </Tooltip>
                                    }
                                  >
                                    <div
                                      ...
                                      className={
                                        "d-flex pointer variant_options_" +
                                        index
                                      }
                                      value={value}
                                    >
              ...
              <div className="row mt-3">
                <div className="col-4 col-md-3">
                  <div className="d-flex align-items-start">
                    <div className="line_height_dense">Order Notes&nbsp;</div>
                  </div>
                </div>
                  ...
                  <Link to="/contact-us" className="no_underline">
                    ...
                    >
                      ...
                      <OverlayTrigger
                        ...
                        delay={{ show: 250, hide: 400 }}
                        overlay={
                          <Tooltip id="button-tooltip-free-design">
                            Need help? Get a free consultation from our
                            designers!
                          </Tooltip>
                        }
                      >
              ...
              <em className="font_xs font_grey_medium_2">{deliverLT}</em>
            </div>
          </div>
        </div>
      </div>
              ...
              <div className="container">
                <div className="row row_padding font_white">
                  ...
                  <div className="col-12 col-md-4 offset-md-1 order-1 order-md-2">
                    ...
                    <p>
                      Want more customisation ideas for the Acacia Blocks? Check
                ...
                <div className="row row_padding">
                  <div className="col-md-8 offset-md-2 col-lg-7 offset-lg-0 align-self-center">
                    ...
                    <p className="mb-50">
                      ...
                      Acacia Blocks. Regardless of your interior style, the
                      Acacia Blocks can fit into any spaces of yours – meeting
                ...
                <div className="row row_padding">
                  <div className="col-12">
                    <h2 className="text-uppercase pb-3">
                      Meet the Min+Modules
                    </h2>
                    <p className="mb-80">
                      The Min+Modules is more than just your average furniture
                      piece. It's modular.
                    </p>
                  </div>
              ...
              <div className="container">
                <div className="row row_padding d-flex">
                  <div className="col-md-6 p-5 align-self-center">
                    <img
                      src="/shop/min_modules/customise.png"
                      alt="Customise"
                    />
                  </div>
                  <div className="col-md-6 align-self-center">
                    ...
                    <p className="mb-50">
                      Customise your very own Min+Modules furniture with our
                      product configurator – right down to details such as
              ...
              <div className="container">
                <div className="row row_padding">
                  <div className="col-md-8 offset-md-2 col-lg-6 offset-lg-0 align-self-center">
                    ...
                    <p className="mb-50">
                      Get inspirations on how to style your spaces with the
                      Min+Modules. Regardless of your interior style, the
                      Min+Modules can fit into any spaces of yours – meeting all
